                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a href="{{ route('user#home') }}" class="nav-item nav-link active me-5">Home</a>
                            <a href="{{ route('user#cartList') }}" class="nav-item nav-link me-5">My Cart</a>
                            <a href="{{ route('user#history') }}" class="nav-item nav-link me-5">My Order</a>
                            <a href="{{ route('user#homePage') }}" class="nav-item nav-link me-5">Customer Care</a>
                        </div>
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">

                            <div class="dropdown">
                                <a href="#"
                                    class="btn btn-dark dropdown-toggle rounded-pill p-1 m-1 text-white border"
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="{{ route('user#accountChangePage') }}" class="dropdown-item my-2"><i
                                                class="fa-solid fa-user me-3"></i>Account</a></li>
                                    <li> <a href="{{ route('user#passwordchangePage') }}" class="dropdown-item my-2"><i
                                    ...
                                    <li>
                                        <span class="dropdown-item">
                                            <form action="{{ route('logout') }}" method="POST" class="d-inline">
                                                @csrf
                                                <button class="btn btn-dark text-white me-3 my-2" type="submit"><i
